...
from mev_analysis.schemas.prices import CETH_TOKEN_ADDRESS, ETH_TOKEN_ADDRESS
...
class CompoundLiquidationClassifier(LiquidationClassifier):
    ...
    def parse_liquidation(
        ...
        debt_purchase_amount, debt_token_address = (
            ...
            if debt_token_address.lower() == CETH_TOKEN_ADDRESS and liquidation_trace.value != 0
